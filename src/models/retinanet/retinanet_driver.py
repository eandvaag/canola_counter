...
def train(config):
    ...
    for seq_num in range(len(config.training["training_sequence"])):
        ...
        #train_data_loader = data_load.MixedDataLoader(training_tf_record_paths_obj, training_tf_record_paths_bg,
        ...
        #val_data_loader = data_load.MixedDataLoader(validation_tf_record_paths_obj, validation_tf_record_paths_bg,
