...
from models.detectors.retinanet.backbones.resnet import resnet_50_backbone, \
                                                        resnet_101_backbone, \
                                                        resnet_152_backbone
...
def get_backbone(backbone_name):
    ...
    if backbone_name == "resnet_50":
        ...
        raise RuntimeError("Unknown backbone: '{}'.".format(backbone.name))
...
class RetinaNet(keras.Model):
    ...
    def __init__(self, config):
        ...
        backbone = get_backbone(config.backbone_name)
