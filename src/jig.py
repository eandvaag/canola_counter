...
def jig(w,h,n,b=0):
    ...
    for dis_range in [up_range,down_range]:
        ...
        for i in dis_range:
            ...
            if yes == 1:
                ...
                if badness_score < best:
                    best = badness_score
                    # best_piece_ratio = piece_ratio
                    # final_best_n = best_n
                    final_best_n_sides = best_n_sides
                ...
                #         best_piece_ratio_down = piece_ratio
    ...
    # print("best_piece_ratio", best_piece_ratio)

    # print("final_best_n", final_best_n)
    # print("best_piece_ratio", best_piece_ratio)
    # print("final_best_n_sides", final_best_n_sides)
    return {
        # "tile_width": w / final_best_n_sides[0], 
        # "tile_height": h / final_best_n_sides[1],
        "num_x_tiles": final_best_n_sides[0],
        "num_y_tiles": final_best_n_sides[1]
    }